...
const ContactPage = () => {
  return (
    <div className="w-full h-full p-24 md:pl-44 lg:pl-44 bg-[#f5ebe0] dark:bg-medium dark:text-[#96A9C7] text-[#B08C70]">
        <SideBar />
        ...
        <form className="flex flex-col gap-6 pt-10 md:w-2/5 lg:w-2/5 w-full" action="mailto:szoph101@hotmail.co.uk" method="post" enctype="text/plain">
            ...
            <input type="email" name="email" className="opacity-75 focus:opacity-100 rounded-md p-2 dark:bg-[#96A9C7] bg-[#B08C70] text-[#f5ebe0] dark:text-medium placeholder-[#f5ebe0] dark:placeholder-medium focus:outline-none" placeholder="Your email..."></input>
            <textarea placeholder="Your message..." className="opacity-75 focus:opacity-100 rounded-md p-2 h-28 dark:bg-[#96A9C7] bg-[#B08C70] text-[#f5ebe0] dark:text-medium placeholder-[#f5ebe0] dark:placeholder-medium focus:outline-none"></textarea>
            <button className="flex self-end px-4 text-center py-2 dark:bg-[#96A9C7] bg-[#B08C70] text-[#f5ebe0] dark:text-medium rounded-md hover:dark:bg-[#C6D6EC] hover:bg-[#7E4F38]">Send</button>
        </form>
