...
<p className="text-center md:text-right lg:text-right">Task Management App</p></a>
...
<p className="text-center md:text-right lg:text-right">Interactive Hangman Game</p></a>
...
<p className="text-center md:text-right lg:text-right">Weather App</p></a>
...
<p className="text-center md:text-right lg:text-right">Text-Adventure Game</p></a>
