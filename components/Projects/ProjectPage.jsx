...
const ProjectPage = () => {
  return (
    <div className="w-full h-full min-w-screen min-h-screen bg-[#f5ebe0] dark:bg-medium dark:text-[#96A9C7] text-[#B08C70] p-24 md:pl-44 lg:pl-44 flex md:flex-col lg:flex-row flex-col">
      <SideBar />
